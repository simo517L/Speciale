...
powertest_OF = function(Outlier,Data,name,n=NULL,m,squares,newlog = F,DataSize,method=1,Kinterval = c(5:10),path){
  ...
  logpath = "C:/Users/simon/Desktop/SpecialeProject/Speciale/logOF.txt"
...
powertest_OF(Outlier = Matern4a,Data=Data,name ="Power_MaternA_OFNP.Rdata",n=1000,method = 2,m=mm,squares =c(2,2),DataSize=20,newlog=T,path=path )
powertest_OF(Outlier = Matern4a,Data=Data,name ="Power_MaternA_OFST.Rdata",n=1000,method = 3,m=mm,squares =c(2,2),DataSize=20,path=path )

Matern4b = readRDS(file = "Matern_b.Rdata")
powertest_OF(Outlier = Matern4b,Data=Data,name ="Power_MaternB_OFNP.Rdata",n=1000,method = 2,m=mm,squares = c(2,2),DataSize=20,path=path )
powertest_OF(Outlier = Matern4b,Data=Data,name ="Power_MaternB_OFST.Rdata",n=1000,method = 3,m=mm,squares = c(2,2),DataSize=20,path=path )

Clust4a = readRDS(file = "Clust_a.Rdata")
powertest_OF(Outlier = Clust4a ,Data=Data,name ="Power_ClusterA_OFNP.Rdata",n=1000,method = 2,m=mm,squares = c(2,2),DataSize=20,path=path  )
powertest_OF(Outlier = Clust4a ,Data=Data,name ="Power_ClusterA_OFST.Rdata",n=1000,method = 3,m=mm,squares = c(2,2),DataSize=20,path=path  )

Clust4b = readRDS(file = "Clust_b.Rdata")
powertest_OF(Outlier = Clust4b ,Data=Data,name ="Power_ClusterB_OFNP.Rdata",n=1000,method = 2,m=mm,squares = c(2,2),DataSize=20,path=path )
powertest_OF(Outlier = Clust4b ,Data=Data,name ="Power_ClusterB_OFST.Rdata",n=1000,method = 3,m=mm,squares = c(2,2),DataSize=20,path=path )

Clust4c = readRDS(file = "Clust_c.Rdata")
powertest_OF(Outlier = Clust4c ,Data=Data,name ="Power_ClusterC_OFNP.Rdata",n=1000,method = 2,m=mm,squares = c(2,2),DataSize=20,path=path  )
powertest_OF(Outlier = Clust4c ,Data=Data,name ="Power_ClusterC_OFST.Rdata",n=1000,method = 3,m=mm,squares = c(2,2),DataSize=20,path=path  )


poistest  = readRDS(file = "poisPPP.Rdata")
powertest_OF(Outlier = poistest ,Data=Data,name ="pois_OFNP.Rdata",n=1000,method = 2,m=mm,squares = c(2,2),DataSize=20 ,path=path )
powertest_OF(Outlier = poistest ,Data=Data,name ="pois_OFST.Rdata",n=1000,method = 3,m=mm,squares = c(2,2),DataSize=20,path=path  )
