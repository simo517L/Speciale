...
m=1000
intval = seq(1,m,10)
logpath = "C:/Users/simon/Desktop/SpecialeProject/Speciale/logHC.txt" # Remember to add your own logpath "
path_of_log<-file(logpath)
name1 ="eval1T4diana.Rdata"
name2 ="eval2T4diana.Rdata"
name3 ="eval3T4diana.Rdata"
...
hceval1 <- foreach (i= c(1:10), .combine="cbind", .packages = c("spatstat","cluster","fossil")) %dopar% {
  ...
  eval_clust(MM,k=3,true_label =TrueLabel,methodhc = T)
}
...
hceval3 <- foreach (i= c(1:10), .combine="cbind", .packages = c("spatstat","cluster","fossil")) %dopar% {
  ...
  eval_clust(MM,k=6,true_label =TrueLabel,methodhc = T)
}
...
name1 ="eval1T6diana.Rdata"
name2 ="eval2T6diana.Rdata"
name3 ="eval3T6diana.Rdata"
path_of_log<-file(logpath)
TrueLabel = c(rep(1,5),rep(2,5),rep(3,5))
hceval1 <- foreach (i= c(1:10), .combine="cbind", .packages = c("spatstat","cluster","fossil")) %dopar% {
  vec = c((i*5-4):(i*5))
...
name1 ="eval1T9diana.Rdata"
name2 ="eval2T9diana.Rdata"
name3 ="eval3T9diana.Rdata"
path_of_log<-file(logpath)
TrueLabel = c(rep(1,5),rep(2,5),rep(3,5))
hceval1 <- foreach (i= c(1:10), .combine="cbind", .packages = c("spatstat","cluster","fossil")) %dopar% {
  vec = c((i*5-4):(i*5))
...
name1 ="eval1T12diana.Rdata"
name2 ="eval2T12diana.Rdata"
name3 ="eval3T12diana.Rdata"
path_of_log<-file(logpath)
TrueLabel = c(rep(1,5),rep(2,5),rep(3,5))
hceval1 <- foreach (i= c(1:10), .combine="cbind", .packages = c("spatstat","cluster","fossil")) %dopar% {
  vec = c((i*5-4):(i*5))
