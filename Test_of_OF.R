...
#outlier_factors_PP(c(Matern4b[1],Data[1:20]),method = 1,nx=2,ny=2,minpoints = 4,k = c(5:15))
#Test_outlier_OF(Outlier = Matern4b[[1]], PPP = Data[1:20],method = 1,nx=3,ny=3,minpoints = 5,Kinterval = c(5:15))
#OutlierPPP_Permu(Matern4b[[1]],PPP=Data[[2]], nx = 3, ny = 3, minpoints = 10)
