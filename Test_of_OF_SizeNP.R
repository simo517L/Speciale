...
powertest_OF(Outlier = Matern4a,Data=Data,name ="Size_MaternA_OFNP.Rdata",n=500,method = 2,m=mm,squares =c(2,3),path=path,DataSize=DataSize,newlog=T)

Matern4b = readRDS(file = "Matern_b.Rdata")
powertest_OF(Outlier = Matern4b,Data=Data,name ="Size_MaternB_OFNP.Rdata",n=500,method = 2,m=mm,squares = c(2,3),path=path,DataSize=DataSize,newlog=T)

Clust4a = readRDS(file = "Clust_a.Rdata")
powertest_OF(Outlier = Clust4a ,Data=Data,name ="Size_ClusterA_OFNP.Rdata",n=500,method = 2,m=mm,squares = c(2,3),path=path,DataSize=DataSize )

Clust4b = readRDS(file = "Clust_b.Rdata")
powertest_OF(Outlier = Clust4b ,Data=Data,name ="Size_ClusterB_OFNP.Rdata",n=500,method = 2,m=mm,squares = c(2,3),path=path,DataSize=DataSize)

Clust4c = readRDS(file = "Clust_c.Rdata")
powertest_OF(Outlier = Clust4c ,Data=Data,name ="Size_ClusterC_OFNP.Rdata",n=500,method = 2,m=mm,squares = c(2,3),path=path,DataSize=DataSize )


poistest  = readRDS(file = "poisPPP.Rdata")
powertest_OF(Outlier = poistest ,Data=Data,name ="Size_pois_OFNP.Rdata",n=500,method = 2,m=mm,squares = c(2,3),path=path,DataSize=DataSize )
